...
fields = [
    ...
    FieldSchema(
        ...
        regex_pattern=r"(?:^|[\s:\/])(0?[1-9]|[12]\d|3[01])[\s\/\-\.\+oO+]{1,4}(0?[1-9]|1[012])[\s\/\-\.\+oO+]{1,4}(\d{4})(?:$|[\s,])",
        fuzzy_threshold=75,
        anchor_keywords=["dob", "0ob", "d0r", "date of birth", "जन्म तिथि", "जन्म तारीख",
    ...
    FieldSchema(
        ...
        extraction_method="regex_fuzzy",
        regex_pattern=r"(?i)\b(male|female|transgender|iue|jale|lale|पुरुष|पुरुय|पुठप|महिला|पुरूष)(?:\b|/)",
        fuzzy_threshold=65,
